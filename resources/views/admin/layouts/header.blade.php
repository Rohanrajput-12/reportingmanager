        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="javascript:;">
                <div class="avatar avatar-sm avatar-circle">
                    <img src="{{ asset('admin/dist/img/avatar.jpg') }}" alt="Image" class="avatar-img">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <div class="dropdown-item-text">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-sm avatar-circle ">
                            <img class="" src="{{ asset('admin/dist/img/avatar.jpg') }}" alt="Image" class="avatar-img dropdown-avatar-img">
                        </div>
                        <div class="ms-3">
